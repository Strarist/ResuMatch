...
const capabilities = [
  { feature: 'Semantic skill understanding', traditional: false, resumatch: true },
  { feature: 'Recruiter confidence scoring', traditional: false, resumatch: true },
  { feature: 'Market demand adaptation', traditional: false, resumatch: true },
  { feature: 'Career trajectory modeling', traditional: false, resumatch: true },
  { feature: 'Execution pattern analysis', traditional: false, resumatch: true },
  { feature: 'Keyword extraction', traditional: true, resumatch: true },
  { feature: 'PDF parsing', traditional: true, resumatch: true },
  { feature: 'Opportunity ranking intelligence', traditional: false, resumatch: true },
];
      ...
      <div className="max-w-[720px] mx-auto">
        <Reveal className="mb-12">
          ...
          <p className="mt-3 text-[14px] text-white/30 leading-relaxed max-w-md">
            Static parsers extract keywords. ResuMatch orchestrates an autonomous career operating system.
          </p>
        </Reveal>
        ...
        >
          ...
          <div className="grid grid-cols-[1fr_80px_80px] sm:grid-cols-[1fr_100px_100px] px-4 py-3 border-b border-white/[0.04] bg-white/[0.02]">
            ...
            <span className="text-[11px] text-blue-400/70 font-medium text-center">ResuMatch</span>
          </div>
